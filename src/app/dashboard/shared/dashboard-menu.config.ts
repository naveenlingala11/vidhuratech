...
export const DASHBOARD_MENUS: Record<string, DashboardMenuItem[]> = {
  ...
  ADMIN: [
    ...
    { label: 'Public Practice', icon: 'bi bi-globe-central-south-asia', route: '/dashboard/admin/public-practice', },
    { label: 'Manage Trainers', icon: 'bi bi-person-workspace', route: '/dashboard/admin/manage-trainers', },
    { label: 'Admissions', icon: 'bi bi-mortarboard', route: '/dashboard/admin/admissions' },
    { label: 'Batch Communication', icon: 'bi bi-chat-dots', route: '/dashboard/admin/batch-communication',},
    ...
    { label: 'Courses', icon: 'bi bi-journal-bookmark', route: 'dashboard/lms/courses' },
