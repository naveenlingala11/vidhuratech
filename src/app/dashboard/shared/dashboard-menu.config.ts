...
export const DASHBOARD_MENUS: Record<string, DashboardMenuItem[]> = {
  STUDENT: [
    ...
    { label: 'My Mentors', icon: 'bi bi-person-workspace', route: '/dashboard/student/my-mentors' },
    { label: 'Mentor Sessions', icon: 'bi bi-calendar2-check', route: '/dashboard/student/mentor-sessions' },
    { label: 'Mentorship Progress', icon: 'bi bi-graph-up-arrow', route: '/dashboard/student/mentor-progress' },
  ...
  ADMIN: [
    ...
    },
    {
      ...
      route: '/dashboard/admin/user-guide',
    },
    {
    ...
    },
    {
      ...
      route: '/dashboard/admin/manage-mentors',
    },
    ...
    { label: 'LMS Courses', icon: 'bi bi-journal-bookmark-fill', route: '/dashboard/lms/courses' },
    { label: 'Course Manager', icon: 'bi bi-kanban', route: '/dashboard/lms/courses-manager' },
    { label: 'Leads', icon: 'bi bi-person-lines-fill', route: '/dashboard/admin/leads' },
    { label: 'Bin', icon: 'bi bi-trash', route: '/admin/bin' },
    { label: 'Jobs', icon: 'bi bi-briefcase', route: '/dashboard/admin/jobs' },
    { label: 'Companies', icon: 'bi bi-building', route: '/dashboard/admin/companies' },
    { label: 'Certificates', icon: 'bi bi-award', route: '/dashboard/admin/certificates' },
    { label: 'Invoices', icon: 'bi bi-receipt', route: '/dashboard/admin/invoice' },
    { label: 'Analytics', icon: 'bi bi-graph-up', route: '/dashboard/admin/invoice-analytics' },
  ...
  MENTOR: [
    ...
    { label: 'Edit Profile', icon: 'bi bi-pencil-square', route: '/dashboard/mentor/edit-profile' },
    { label: 'My Mentees', icon: 'bi bi-people', route: '/dashboard/mentor/mentees' },
    { label: 'Sessions', icon: 'bi bi-calendar-event', route: '/dashboard/mentor/sessions' },
    { label: 'Earnings', icon: 'bi bi-cash-stack', route: '/dashboard/mentor/earnings' },
    { label: 'Availability', icon: 'bi bi-clock-history', route: '/dashboard/mentor/availability' },
    { label: 'Public Directory', icon: 'bi bi-globe', route: '/mentors' },
