...
export const DASHBOARD_MENUS: Record<string, DashboardMenuItem[]> = {
  STUDENT: [
    ...
    },
    {
      ...
      route: '/dashboard/student/live-sessions',
    },
  ...
  TRAINER: [
    ...
    },
    {
      label: 'Live Sessions',
      icon: 'bi bi-broadcast',
      route: '/dashboard/trainer/live-sessions',
    },
  ...
  MENTOR: [
    ...
    { label: 'Sessions', icon: 'bi bi-calendar-event', route: '/dashboard/mentor/sessions' },
    {
      label: 'Live Sessions',
      icon: 'bi bi-broadcast',
      route: '/dashboard/mentor/live-sessions',
    },
  ...
  USER: [
    { label: 'Dashboard', icon: 'bi bi-grid', route: '/dashboard/user' },
    { label: 'Profile', icon: 'bi bi-person-circle', route: '/dashboard/user/profile' },
    { label: 'Browse Courses', icon: 'bi bi-search', route: '/courses' },
    { label: 'Explore Projects', icon: 'bi bi-diagram-project', route: '/projects' },
    { label: 'Practice Arena', icon: 'bi bi-code-square', route: '/practice' },
    { label: 'Resume Builder', icon: 'bi bi-file-earmark-person', route: '/resume' },
    { label: 'Jobs & Careers', icon: 'bi bi-briefcase', route: '/jobs-home' },
    { label: 'Leaderboard', icon: 'bi bi-trophy', route: '/leaderboard' },
    { label: 'Find Mentors', icon: 'bi bi-people', route: '/mentors' },
    { label: 'Notifications', icon: 'bi bi-bell', route: '/dashboard/user/notifications' },
    { label: 'Settings', icon: 'bi bi-gear', route: '/dashboard/user/settings' },
  ],
};
